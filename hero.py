...
player_sit_right = spritesheet.subsurface(pygame.Rect((274,1201), (43, 38)))
player_sit_left = pygame.transform.flip(spritesheet.subsurface(pygame.Rect((274,1201), (43, 38))), True, False)
...
climb_frame_width = 43
climb_frame_height = 78 + 120
climb_frame_count = 25
climb_pos = [(1066 - i * (climb_frame_width+1), 2803) for i in range(climb_frame_count)]
...
climb_down_frame_width = 43
climb_down_frame_height = 78 + 120
climb_down_frame_count = 25
climb_down_pos = [(10 + i * (climb_down_frame_width+1), 2803) for i in range(climb_down_frame_count)]
