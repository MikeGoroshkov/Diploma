...
### <center>"Создания Desktop-игры на Python с использованием библиотеки Pygame и применением возможностей нейросетей"</center>
...
### <a id="2.8">VIII. Сборка приложения</a>
...
1. Убедитесь, что вы установили PyInstaller на свой компьютер. Если необходимо установить PyInstaller, используйте 
...
### <a id="2.9">IX. Применение нейросетевых моделей</a>
...
### <a id="2.10">X. Тестирование и отладка игры</a>
...
I. Исходный код игры представлен следующими файлами:
...
III. Примеры промптов и результатов в Stable Diffusion 1.5 находятся в файле
annex_3.md
