...
5. [Приложения:](#5)
   1. Исходный код игры
   2. Примеры промптов и результатов в Stable Diffusion 1.5
   3. Примеры промптов и ответов в чат-помощнике Bing (GPT-4)
...
### <a id="2.8">IX. Применение нейросетевых моделей</a>
...
### <a id="2.9">VIII. Сборка приложения</a>
...
II. Примеры промптов и результатов в Stable Diffusion 1.5 находятся в файле
annex_2.md

III. Примеры промптов и ответов в чат-помощнике Bing (GPT-4) находятся в файле
annex_3.md
